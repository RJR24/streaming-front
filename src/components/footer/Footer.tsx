...
const SITEMAP = [
  ...
  {
    title: "Help Center",
    links: ["Jobs", "Terms of Use", "Contact Us"],
  },
  {
    title: "Account",
    links: ["Redeem Gift Cards", "Privacy", "Speed Test"],
  },
  {
    title: "Media Center",
    links: ["Buy Gift Cards", "Cookie Preferences", "Legal Notices"],
  },
];
              ...
              <ul className="space-y-1">
                {links.map((link, key) => (
                  ...
                  >
                    <a
                      href="#"
                      className="inline-block py-1 pr-2 ml-8  whitespace-nowrap transition-transform hover:text-zinc-400 text-zinc-500 text-xs font-normal font-['Netflix Sans']"
                    >
                      {link}
                    </a>
                  </Typography>
